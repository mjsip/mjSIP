...
public class SdpMessage {
	...
	private void init(OriginField o, SessionNameField s, ConnectionField c, TimeDescription[] tv) {
		...
		this.c=c;
		if (tv!=null) {
			this.tv=new TimeDescription[tv.length];
			System.arraycopy(tv,0,this.tv,0,tv.length);
		}
		else this.tv=new TimeDescription[]{new TimeDescription(new TimeField())};
	}
	...
	public SdpMessage(String sdp) {
		...
		else tv=new TimeDescription[] {new TimeDescription(new TimeField())};
