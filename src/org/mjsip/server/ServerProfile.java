...
public class ServerProfile extends Configure {
	...
	/** The type of location service.
	  ...
	  * or the class name (e.g. org.mjsip.server.LocationServiceImpl). */
	...
	/** The authentication scheme.
	  ...
	  * or the class name (e.g. org.mjsip.server.AuthenticationServerImpl). */
	...
	/** The type of authentication service.
	  ...
	  * or the class name (e.g. org.mjsip.server.AuthenticationServiceImpl). */
