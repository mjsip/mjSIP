...
public class SrRtcpPacket extends RrRtcpPacket {
	...
	public static class SenderInfo {
		...
		public void setNtpTimestamp(long time) {
			...
			BinUtils.setLong(ts.getNtpSeconds(),buf,off,off+4);
			BinUtils.setLong(ts.getNtpFraction(),buf,off+4,off+8);
		}

		/** Gets NTP timestamp.
		  * @return the wallclock time (in Java format) when this report is sent */
		public long getNtpTimestamp() {
			long seconds=BinUtils.getLong(buf,off,off+4);
			long fraction=BinUtils.getLong(buf,off+4,off+8);
		...
		public void setRtpTimestamp(long rtp_timestamp) {
			BinUtils.setLong(rtp_timestamp,buf,off+8,off+12);
		}
		...
		public void setPacketCount(long packet_count) {
			BinUtils.setLong(packet_count,buf,off+12,off+16);
		}
		...
		public void setOctectCount(long octect_count) {
			BinUtils.setLong(octect_count,buf,off+16,off+20);
		}
