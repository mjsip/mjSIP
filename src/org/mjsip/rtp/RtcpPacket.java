...
public class RtcpPacket {
	...
	/** Creates a new RTCP packet. 
	  * @param data the RTCP packet */ 
	public RtcpPacket(byte[] data) {
		this(data,0);
	}

	/** Creates a new RTCP packet.
	  * @param udp_packet UDP packet containing the RTCP packet */ 
	public RtcpPacket(UdpPacket udp_packet) {
		this(udp_packet.getData(),udp_packet.getOffset());
	}
	...
	public int getPacketLength() {
		return (BinUtils.getInt(buffer,2,4)+1)*4;
	}
	...
	public void setPacketLength(int len) {
		BinUtils.setInt(len/4-1,buffer,2,4);
	}

	
	/** Gets a UDP packet containing this RTCP packet.
	  * @param dest_soaddr destination socket address */
	public UdpPacket toUdpPacket(SocketAddress dest_soaddr) {
		UdpPacket udp_packet=new UdpPacket(buffer,offset,getPacketLength());
