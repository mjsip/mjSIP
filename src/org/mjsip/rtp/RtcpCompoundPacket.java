...
public class RtcpCompoundPacket {
	...
	/** Creates a new RTCP compound packet.
	...
	/** Creates a new RTCP compound packet.
	 * @param data the RTCP compound packet */
	public RtcpCompoundPacket(byte[] data) {
		this(data,0,data.length);
	}

	/** Creates a new RTCP compound packet.
	 * @param udp_packet UDP packet containing the compound packet */
	public RtcpCompoundPacket(UdpPacket udp_packet) {
	...
	/** Gets a UDP packet containing this RTCP compound packet.
