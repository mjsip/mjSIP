...
public class CancelServer {
	...
	/** Creates a new CancelServer. */
	public CancelServer(SipProvider sip_provider) {
		this.sip_provider=sip_provider;
		sip_provider.addSelectiveListener(new MethodId(SipMethods.CANCEL),this_sip_provider_listener);  
	} 
	...
	void log(String str) {
		...
		if (logger!=null) logger.log(LoggerLevel.INFO,"CancelServer: "+str);  
	}
