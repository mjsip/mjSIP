...
public class OptionsServer {
	...
	private void init(SipProvider sip_provider, String allow, String accept, String accept_encoding, String accept_language, String[] supported_option_tags) {
		...
		sip_provider.addSelectiveListener(new MethodId(SipMethods.OPTIONS),this_sip_provider_listener);  
	} 
	...
	void log(String str) {
		...
		if (logger!=null) logger.log(LoggerLevel.INFO,"OptionsServer: "+str);  
	}
