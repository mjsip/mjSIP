...
/** Jukebox is a simple audio server.
  ...
  * <p>
  * It is single-call UA, that is it serves ONE call at a time.
  */
public class MiniJukeboxUA extends UserAgentCli {
	...
	public MiniJukeboxUA(SipProvider sip_provider, UserAgentProfile user_profile) {
	...
	public static void main(String[] args) {
		...
		new MiniJukeboxUA(UA.sip_provider,UA.ua_profile);
	}    
