...
public class AudioApp {
	...
	protected AudioStreamer createAudioStreamer(FlowSpec flow_spec, String audiofile_in, String audiofile_out, boolean direct_convertion, Codec additional_encoding, boolean do_sync, int random_early_drop, boolean symmetric_rtp, boolean rtcp) {
		return new AudioStreamer(flow_spec,audiofile_in,audiofile_out,direct_convertion,additional_encoding,do_sync,random_early_drop,symmetric_rtp,rtcp);
	}
	...
	public void run(String[] args) {
		...
		AudioStreamer audio_streamer=createAudioStreamer(fspec,audio_in,audio_out,direct_convertion,null,do_sync,random_early_drop,symmetric_rtp,rtcp);
