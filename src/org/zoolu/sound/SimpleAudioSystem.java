...
public class SimpleAudioSystem {
	...
	private static void debug(String str) {
		...
		System.out.println(SystemUtils.getSimpleClassName(SimpleAudioSystem.class.getName())+": "+str);
	}
	...
	private static void error(String str) {
		...
		System.err.println(SystemUtils.getSimpleClassName(SimpleAudioSystem.class.getName())+": "+str);
	}
