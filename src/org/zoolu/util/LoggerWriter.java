...
/** Simple logger that writes log messages onto a logfile, or standard output, or {@link java.io.Writer}, or {@link java.io.OutputStream}
  ...
  * When adding a log message through the methods {@link Logger#log(LoggerLevel,String)} or {@link Logger#log(LoggerLevel,Class,String)}
...
public class LoggerWriter implements Logger {
	...
	/** Sets the logging level.
	  * @param logging_level the logging level */
	public void setLoggingLevel(LoggerLevel logging_level)  {
		this.logging_level=logging_level;
	}
	...
	public void log(String message) {
		log(LoggerLevel.INFO,null,message);
	}
