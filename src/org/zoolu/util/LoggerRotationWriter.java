...
/** It extends LoggerWriter providing rotation of the log file. 
  */
public class LoggerRotationWriter extends LoggerWriter {
	...
	/** Creates a new LoggerRotationWriter.
	...
	public LoggerRotationWriter(String file_name, LoggerLevel verbose_level, long max_size, int num_rotations, int time_scale, int time_value) {
	...
	public LoggerRotationWriter(String file_name, LoggerLevel verbose_level, long max_size, int num_rotations, int time_scale, int time_value, boolean append) {
	...
	/** Rotates logs. */
	public synchronized LoggerRotationWriter rotate() {
		if (num_rotations>0) {
